...
class PurePursuit(object):
    ...
    def __init__(self):
        ...
        self.desired_speed = 1        # m/s, reference speed, was 1.5
        ...
        # To make GEM refresh its waypoint-record
        self.num_finished_wpts  = 0 
        self.waypoints_reload_threshold = 3

    def copy_csv(self, csv_string):
        # with io.StringIO(csv_string) as csv_in, open ('/home/gem/Documents/gem_07/src/waypoints_pp.csv', 'w', newline='') as out_csv:
        #     csv_reader = reader(csv_in)
        #     csv_writer = writer(out_csv)
        #     for row in csv_reader:
        #         csv_writer.writerow(row)

        source = r"/home/gem/Documents/gem_07/src/waypoints.csv"
        target = r"/home/gem/Documents/gem_07/src/waypoints_pp.csv"
    ...
    def read_waypoints(self):
        ...
        self.copy_csv(filename)

        filename = os.path.join(dirname, '../../../waypoints_pp.csv')
    ...
    def start_pp(self):
        ...
        while not rospy.is_shutdown():
            ...
            # Reload waypoints if finished all waypoints from the current read
            print("num_finished_wpts = " + str(self.num_finished_wpts))
            if self.num_finished_wpts == self.waypoints_reload_threshold:
                print("inside if statement")
                self.num_finished_wpts = 0
                self.read_waypoints()

            self.num_finished_wpts += 1
